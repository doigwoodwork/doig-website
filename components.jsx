...
export function Img({ src, alt, aspect, label, className = '', style }) {
...
// ============== Section header ==============
export function SectionHeader({ eyebrow, headline, body, align = 'start', cta }) {
  return (
...
// ============== Tweaks panel ==============
export function TweaksPanel({ visible, onClose }) {
  const { lang, setLang } = useLang();
